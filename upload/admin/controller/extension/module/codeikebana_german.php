<?php
class ControllerExtensionModuleCodeIkebanaGerman extends Controller
{
    /**
    ...
    // Language
    private $language_de = array(
        'name' => 'German',
        'code' => 'de',
        'locale' => 'de,de-DE,de_DE,de_DE.UTF-8,de-de,de-AT,de-CH,german',
        'sort_order' => '1',
        'status' => '1'
    );
...
//    );
    ...
    private $order_statuses = array(
        ...
        'Canceled Reversal' => 'Stornierte Stornierung',
...
//    );
    ...
    public function install()
    {
        ...
        // Language
        $language_id = $this->model_localisation_language->addLanguage($this->language_de);
...
//        }
        ...
        $toSaveData = ['codeikebana_german_language_id' => $language_id,
//                       'codeikebana_german_currency_id'     => $currency_id,
//            'codeikebana_german_geo_zone_id' => $geo_zone_id,
//            'codeikebana_german_tax_rate_23_id' => $tax_rate_23_id,
//            'codeikebana_german_tax_rate_8_id' => $tax_rate_8_id,
//            'codeikebana_german_tax_rate_5_id' => $tax_rate_5_id,
//            'codeikebana_german_tax_class_23_id' => $tax_class_23_id,
//            'codeikebana_german_tax_class_8_id' => $tax_class_8_id,
//            'codeikebana_german_tax_class_5_id' => $tax_class_5_id
        ];

        $this->model_setting_setting->editSetting('codeikebana_german', $toSaveData);
    }
    ...
    public function uninstall()
    {
        // retrive saved id's
        $this->load->model('setting/setting');
        $module_settings = $this->model_setting_setting->getSetting('codeikebana_german');
        // Language
        $this->load->model('localisation/language');
        $this->model_localisation_language->deleteLanguage($module_settings['codeikebana_german_language_id']);

        // Currency
//        $this->load->model('localisation/currency');
//        $this->model_localisation_currency->deleteCurrency($module_settings['codeikebana_german_currency_id']);
        // reveresed order tax class - tax rate - geo zone
        // tax classes
//        $this->load->model('localisation/tax_class');
//        // 23
//        $this->model_localisation_tax_class->deleteTaxClass($module_settings['codeikebana_german_tax_class_23_id']);
//        // 8
//        $this->model_localisation_tax_class->deleteTaxClass($module_settings['codeikebana_german_tax_class_8_id']);
//        // 5
//        $this->model_localisation_tax_class->deleteTaxClass($module_settings['codeikebana_german_tax_class_5_id']);
//
//        // tax rates
//        $this->load->model('localisation/tax_rate');
//        // 23
//        $this->model_localisation_tax_rate->deleteTaxRate($module_settings['codeikebana_german_tax_rate_23_id']);
//        // 8
//        $this->model_localisation_tax_rate->deleteTaxRate($module_settings['codeikebana_german_tax_rate_8_id']);
//        // 5
//        $this->model_localisation_tax_rate->deleteTaxRate($module_settings['codeikebana_german_tax_rate_5_id']);
//
//        // Add geo zone
//        $this->load->model('localisation/geo_zone');
//        $this->model_localisation_geo_zone->deleteGeoZone($module_settings['codeikebana_german_geo_zone_id']);

        // remove settings
        $this->model_setting_setting->deleteSetting('codeikebana_german');
